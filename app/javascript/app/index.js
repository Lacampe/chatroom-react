...
const notifications = JSON.parse(node.getAttribute('notifications'))

ReactDOM.render(<App chatrooms={chatrooms} current_user={current_user} default_active_chatroom={default_active_chatroom} notifications={notifications} />, node)
